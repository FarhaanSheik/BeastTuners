...
namespace BeastTuners.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(BeastTunersContext context)
        {
            _context = context;
        }
        ...
        {
            var beastTunersContext = _context.OrderDetail.Include(o => o.OrderResult).Include(o => o.Part);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailID,OrderID,PartID,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            ...
            ViewData["OrderID"] = new SelectList(_context.Set<OrderResult>(), "OrderID", "Status", orderDetail.OrderID);
            ViewData["PartID"] = new SelectList(_context.Set<Part>(), "PartID", "Category", orderDetail.PartID);
            return View(orderDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailID,OrderID,PartID,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
